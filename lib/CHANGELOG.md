...
- *(deps)* Bump russh from 0.54.5 to 0.54.6 ([#162](https://github.com/pbar1/astu/pull/162))
- *(deps)* Bump borrow-or-share from 0.2.2 to 0.2.4 ([#172](https://github.com/pbar1/astu/pull/172))
- *(deps)* Bump k8s-openapi from 0.26.0 to 0.27.0 ([#178](https://github.com/pbar1/astu/pull/178))
- *(deps)* Bump whoami from 1 to 2
